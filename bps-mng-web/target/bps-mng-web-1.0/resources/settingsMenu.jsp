		...
		<div class="contentBox">
			...
			<div id="tree">
				...
				<li class="folder">User Settings
					<ul>
						<li class="external"><a target="settingsTarget" href="<%= request.getContextPath()%>/resources/userProfileSettings.jsp">User Profile</a>
						<li class="external"><a target="settingsTarget" href="<%= request.getContextPath()%>/resources/userPrivilegeSettings.jsp">User Privileges</a>
						<li class="external"><a target="settingsTarget" href="<%= request.getContextPath()%>/resources/userGroupSettings.jsp">User Groups</a>
					</ul>
				</ul>
			</div>
		</div>
